            ...
            <div class="col-md-4 mx-auto">
                <?php if (isset($_SESSION['mensaje_registro'])) { ?>
                    <div class="alert alert-<?= $_SESSION['tipo-mensaje']; ?> alert-dismissible fade show" role="alert">
                        <?php echo $_SESSION['mensaje_registro']; ?>
                ...
                <div class="card card-body">
                    <form action="signup.php" method="POST">
                        ...
                        <div class="input-group flex-nowrap">
                            <span class="input-group-text" id="addon-wrapping"></span>
                            <input type="password" class="form-control" placeholder="Confirmar contraseña" aria-describedby="addon-wrapping" pattern="^(?=.*[A-Za-z])(?=.*[@#$%]).{8,}$" title="Debe contener una letra mayúscula, una minúscula, un caracter especial (@#$%) y como mínimo 8 caracteres" id="contConfir" onfocusout="validar2()" required>
                        </div>
                        <br>
                        <center>
                            <input type="submit" class="btn btn-success btn-block" name="save" id="save" value="Registrarse" disabled></inpunt>
                        </center>
                    </form>
                </div>
